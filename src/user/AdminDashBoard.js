...
const AdminDashBoard = () => {
    ...
    //"isAuthenticated()" returns an "user" object with _id, name, email and role
    ...
    return (
            ...
            <Base title="Welcome to Admin Page" description="Manage all of your products here"
            className="adminDashboardMargin container bg-primary p-4 "
            >
                <div className=" row">
